return {
  {
    ...
    config = function()
      ...
      -- Keymaps
      vim.keymap.set("n", "<leader>gd", function() Snacks.picker.lsp_definitions() end, options)
      vim.keymap.set("n", "<leader>gr", function() Snacks.picker.lsp_references() end, options)
    ...
    config = function()
      ...
      null_ls.setup({
        sources = {
          ...
          null_ls.builtins.formatting.prettierd.with(prettierd_config),
